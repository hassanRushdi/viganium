...
export default function ContactSection() {
  ...
  const { formData, formStatus, handleInputChange, handleSubmit, resetForm } =
    useContactForm();
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="relative mb-12 flex justify-center items-center perspective-[1000px]">
          ...
          >
            ...
            <div
              className="absolute inset-0 bg-white border-[10px] border-gray-200 shadow-xl rounded-2xl p-6 md:p-8 flex flex-col items-center justify-center text-center"
              style={{
            ...
            >
              ...
              <p className="text-gray-700 mb-8">{t("success.message")}</p>
              ...
              <button
                ...
                className="w-full max-w-md py-3 bg-gray-800 text-white rounded-md hover:bg-gray-900 transition"
              >
                {t("success.button")}
              </button>
            </div>
